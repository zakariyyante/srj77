  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#030b1a]/95 backdrop-blur-sm overflow-y-auto">
      <div className="w-full min-h-screen bg-[#030b1a] felt-texture">
        ...
        {/* Hero Section */}
        <div className="bg-[#06061b] border-b border-white/10 px-4 sm:px-6 py-3 sm:py-4 backdrop-blur">
          <div className="container mx-auto">
            ...
            <h2 className="text-left sm:text-xl font-extrabold gold-text mb-1">
              {isOnline ? 'Exclusive welcome offers with fast withdrawals at the UK\'s best-rated platforms.' : 'Browse the top-rated casinos across the UK'}
            </h2>
          </div>
        </div>
