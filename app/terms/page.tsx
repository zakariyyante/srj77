  ...
  return (
    <div className="min-h-screen vd-bg">
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 max-w-4xl">
        <div className="rounded-3xl p-6 sm:p-8 lg:p-12 shadow-xl" style={{ background: '#0c1223', border: '1px solid rgba(244,185,66,0.10)' }}>
          <div className="mb-6 sm:mb-8">
            <div className="inline-block vd-eyebrow mb-4">Legal</div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white">
              Terms of Service
            </h1>
          </div>

          <div className="text-white/55 text-sm sm:text-base leading-relaxed space-y-6">
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">3. Age Restrictions</h2>
              <p>
              ...
              <p className="mt-3">
                Online gambling is illegal for individuals under the age of 18 in the United
                Kingdom. We do not knowingly provide information to minors.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">4. Use of Service</h2>
              <p>
              ...
              <ul className="list-disc list-inside ml-4 space-y-2 mt-2">
                ...
                <li>
                  Use any automated system to access the Service without our express written
                  permission
                </li>
                <li>
                  Reproduce, duplicate, copy, or resell any part of the Service without our
                  permission
                </li>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">5. Third-Party Links and Services</h2>
              <p>
                Our Service contains links to third-party websites, including online casino
                operators. We are not responsible for the content, privacy policies, or practices
                of any third-party websites.
              </p>
              <p className="mt-3">
                When you click on links to third-party casinos, you will leave our Website and be
                subject to the terms and conditions and privacy policies of those third-party
                websites. We encourage you to review the terms and privacy policies of any
                third-party websites you visit.
              </p>
              <p className="mt-3">
                We may receive compensation from casino operators when you click on links or sign
                up through our Service. This does not affect our editorial independence or the
                accuracy of our reviews.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">6. Disclaimer of Warranties</h2>
              <p>
                The information on this Website is provided on an &ldquo;as is&rdquo; basis. To
                the fullest extent permitted by law, we exclude all representations, warranties,
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">8. Responsible Gambling</h2>
              <p>
                We are committed to promoting responsible gambling. Gambling should be entertaining
                and not seen as a way to make money or solve financial problems.
              </p>
              <p className="mt-3">
              ...
              <ul className="list-disc list-inside ml-4 space-y-2 mt-2">
                <li>
                  <strong className="text-white/70">BeGambleAware:</strong> Visit{' '}
                  <a
                ...
                <li>
                  <strong className="text-white/70">GamCare:</strong> Call 0808 8020 133 or visit{' '}
                  <a
                ...
                <li>
                  <strong className="text-white/70">National Gambling Helpline:</strong> 0808 8020 133
                </li>
              </ul>
              <p className="mt-3">
                Never gamble with money you cannot afford to lose. Set limits on your gambling and
                stick to them.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                Our reviews and ratings are based on our independent evaluation and are not
                influenced by affiliate relationships. We are committed to providing honest,
                accurate, and unbiased information to our users.
              </p>
            </section>

            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">11. Changes to Terms</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">12. Governing Law</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">13. Contact Information</h2>
              <p>
            ...
            <section>
              <h2 className="text-lg sm:text-xl font-bold text-white/90 mb-3">14. Severability</h2>
              <p>
