        ...
        <div className="bg-zinc-900 rounded-3xl p-6 sm:p-8 lg:p-12 border border-white/10 shadow-lg">
          ...
          <div className="text-gray-400 text-sm sm:text-base leading-relaxed space-y-6">
            ...
            <section>
              ...
              <p>
                By accessing and using sweetslotsuk.com (the "Website" or "Service"), you accept and agree
            ...
            <section>
              ...
              <p>
                SweetSlots UK is an information and comparison website that provides reviews, ratings, and
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by applicable law, SweetSlots UK and its owners, employees, 
            ...
            <section>
              ...
              <p>
                The Service and its original content, features, and functionality are owned by SweetSlots UK 
            ...
            <section>
              ...
              <p>
                SweetSlots UK may receive compensation from casino operators when users click on links or 
            ...
            <section>
              ...
              <div className="mt-3 bg-white/5 rounded-2xl p-4 border border-white/10">
                <p className="font-semibold text-white">SweetSlots UK</p>
                <p>
                  Website:{" "}
                  <a
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="border-t border-white/10 pt-4 sm:pt-6 text-center">
            <p className="text-gray-500 text-xs sm:text-sm">
              © 2026 sweetslotsuk.com. For informational purposes only. 18+ only. Please gamble responsibly.
            </p>
